...
def main():
    ...
    # In the incremental model, p_k = min(1, 3/(k-1))
    # The expected number of links per website is 3
    # This is handled within the adjacency generation function
    
    logging.info(f"Number of websites: {NUM_WEBSITES}")
    logging.info(f"Expected out-degree per website: 3")
    ...
    # ========================
    A = generate_incremental_adjacency(NUM_WEBSITES, expected_out_degree=3, seed=RANDOM_SEED, sparse=USE_SPARSE_MATRICES)
